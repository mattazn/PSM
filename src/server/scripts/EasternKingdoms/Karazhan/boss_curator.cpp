    ...
    struct boss_curatorAI : public ScriptedAI
    {
        ...
        void Reset()
        {
            ...
            me->ApplySpellImmune(0, IMMUNITY_DAMAGE, SPELL_SCHOOL_MASK_ARCANE, true);
                me->ApplySpellImmune(1, IMMUNITY_STATE, SPELL_AURA_MOD_TAUNT, true);
					me->ApplySpellImmune(2, IMMUNITY_EFFECT,SPELL_EFFECT_ATTACK_ME, true);
						me->ApplySpellImmune(3, IMMUNITY_EFFECT, SPELL_EFFECT_INTERRUPT_CAST, true);
							me->ApplySpellImmune(4, IMMUNITY_MECHANIC, MECHANIC_INTERRUPT, true);
								me->ApplySpellImmune(5, IMMUNITY_EFFECT,SPELL_AURA_PERIODIC_MANA_LEECH, true);
        }
