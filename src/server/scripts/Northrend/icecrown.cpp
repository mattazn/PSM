...
{
    NPC_RAVENOUS_JAWS           = 29392,
    NPC_BLOOD_CREDIT_BUNNY      = 29391,

    AURA_UNDERWATER_BLOOD       = 47172,

    SPELL_CANCEL_BLOOD          = 26568,
};

class spell_q12810_gore_bladder : public SpellScriptLoader
{
    public:
        spell_q12810_gore_bladder() : SpellScriptLoader("spell_q12810_gore_bladder") { }

        class spell_q12810_gore_bladder_SpellScript : public SpellScript
        {
            PrepareSpellScript(spell_q12810_gore_bladder_SpellScript);
            ...
            void Register()
            {
                OnEffectHitTarget += SpellEffectFn(spell_q12810_gore_bladder_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
            }
        };

        SpellScript* GetSpellScript() const
        {
            return new spell_q12810_gore_bladder_SpellScript();
        }
};
...
public:
    ...
    class spell_throw_writhing_mass_SpellScript : public SpellScript
    {
        ...
        void Register()
        {
            OnEffectHit += SpellEffectFn(spell_throw_writhing_mass_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
        }
    };
...
public:
    ...
    public:
        ...
        void Register()
        {
            OnEffectHit += SpellEffectFn(spell_q_neutralizing_doze_applied_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
        }
    };
