...
{
  {1783.81f, 646.63f, 124.46f, 3.71755f},
  {1775.06f, 614.75f, 124.20f, 1.43117f},
  {1717.39f, 630.041f, 129.282f, 5.96903f},
  {1765.66f, 646.54f, 124.46f,  5.11381f},
    ...
    struct boss_slad_ranAI : public ScriptedAI
    {
        ...
        void EnterCombat(Unit* /*who*/)
        {
            ...
            for(Map::PlayerList::const_iterator itr = players.begin(); itr != players.end(); ++itr)
                lWrappedPlayers.insert(itr->getSource()->GetGUID());
			}
        }
        ...
        void GotWrapped(Unit* unit)
        {
            if(unit && unit->GetTypeId() == TYPEID_PLAYER)
                lWrappedPlayers.erase(unit->GetGUID());
        }
        ...
        void JustDied(Unit* /*killer*/)
        {
            ...
            {
                for(std::set<uint64>::const_iterator itr = lWrappedPlayers.begin(); itr != lWrappedPlayers.end(); ++itr)
                {
...
public:
    ...
    {
        mob_snake_wrapAI(Creature* pCreature) : ScriptedAI(pCreature) { }
