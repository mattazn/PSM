...
enum Spells
{
	...
	SPELL_BERSERKER = 26662,
	SPELL_WRATH_PLAGUEBRINGER_10 = 29214,
	SPELL_WRATH_PLAGUEBRINGER_25 = 54836
};
    ...
    struct boss_nothAI : public BossAI
    {
        ...
        void EnterPhaseGround()
        {
            ...
            else
            {
				...
				switch(balconyCount)
				{
					case 0: events.ScheduleEvent(EVENT_BALCONY, 90000); break;
					case 1: events.ScheduleEvent(EVENT_BALCONY, 110000); break;
					case 2: events.ScheduleEvent(EVENT_BALCONY, 130000); break; // This final timer needs to be looked at.
					case 3: events.ScheduleEvent(EVENT_BALCONY, 90000); me->CastSpell(me, SPELL_BERSERKER); break; // Raid should be dead, we should never get here.
				}
            }
        }
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    ...
                    case EVENT_BLINK:
						...
						randChance = urand(0,3);
						switch(randChance)
						{
						case 0: DoCastAOE(SPELL_BLINK_1); break;
						case 1: DoCastAOE(SPELL_BLINK_2); break;
						case 2: DoCastAOE(SPELL_BLINK_3); break;
						case 3: DoCastAOE(SPELL_BLINK_4); break;
						}
                        DoResetThreat();
                    ...
                    case EVENT_BALCONY:
						...
						normalSpeed = me->GetSpeed(MOVE_RUN);
						me->SetSpeed(MOVE_RUN, 1000.0f, true);
						me->Relocate(TelePos);
						me->StopMoving();
                        events.Reset();
                    ...
                    case EVENT_GROUND:
                    {
                        ...
                        DoCast(SPELL_TELEPORT_RETURN);
						me->Relocate(x,y,z,o);
                        events.ScheduleEvent(EVENT_BALCONY, 110000);
						me->SetSpeed(MOVE_RUN, normalSpeed, true);
                        EnterPhaseGround();
                        return;
                    }
                }
