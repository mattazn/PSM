...
#define CHECK_X             2821.88f
#define CHECK_Y            -3684.89f
#define CHECK_Z             273.62f
...
public:
    ...
    struct boss_heiganAI : public BossAI
    {
        ...
        void EnterPhaseFight()
        {
            ...
            events.ScheduleEvent(EVENT_FEVER, 4000);
        ...
        if(me->GetDistance(CHECK_X, CHECK_Y, CHECK_Z) <= 4)
        {
            ...
            for (std::list<HostileReference*>::iterator itr = m_threatlist.begin(); itr != m_threatlist.end(); ++itr)
                if((*itr)->getTarget()->GetTypeId() == TYPEID_PLAYER)
                    (*itr)->getTarget()->NearTeleportTo(2793.86f, -3707.38f, 276.627f, 0f);
        }*/
