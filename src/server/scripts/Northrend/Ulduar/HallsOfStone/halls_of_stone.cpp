                ...
                switch (uiStep)
                {
                    ...
                    case 5:
                        if (instance)
							...
							if(Unit* temp = GetClosestCreatureWithEntry(me, CREATURE_ABEDNEUM, 50.0f))
                    ...
                    case 7:
                        if (instance)
							...
							if(Unit* temp = GetClosestCreatureWithEntry(me, CREATURE_KADDRAK, 50.0f))
                    ...
                    case 11:
                        if (instance)
							...
							if(Unit* temp = GetClosestCreatureWithEntry(me, CREATURE_MARNAK, 50.0f))
