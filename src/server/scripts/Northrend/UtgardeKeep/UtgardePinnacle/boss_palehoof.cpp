...
public:
    ...
    struct boss_palehoofAI : public ScriptedAI
    {
        ...
        void Reset()
        {
            uiArcingSmashTimer = 7000;
            uiImpaleTimer = 10000;
            uiWhiteringRoarTimer = 15000;
        ...
        void UpdateAI(const uint32 diff)
        {
            ...
            if (uiArcingSmashTimer <= diff)
            {
                ...
                uiArcingSmashTimer = urand(9000, 12000);
    ...
    struct mob_ferocious_rhinoAI : public ScriptedAI
    {
        ...
        void UpdateAI(const uint32 diff)
        {
            ...
            if (uiGrievousWoundTimer <= diff)
            {
                ...
                uiGrievousWoundTimer = 12000 + rand() % 3000;
...
public:
    ...
    struct mob_massive_jormungarAI : public ScriptedAI
    {
        ...
        void Reset()
        {
            uiAcidSpitTimer = 5000;
            uiAcidSplatterTimer = 12000;
            uiPoisonBreathTimer = 15000;
