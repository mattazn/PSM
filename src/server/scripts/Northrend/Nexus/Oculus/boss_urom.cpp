...
public:
    ...
    struct boss_uromAI : public BossAI
    {
        ...
        void CastTeleport()
        {
			...
			DoCast(me, TeleportSpells[instance->GetData(DATA_UROM_PLATAFORM)], true);
        }
        ...
        void UpdateAI(const uint32 uiDiff)
        {
            ...
            if (canCast && !me->FindCurrentSpellBySpellId(SPELL_EMPOWERED_ARCANE_EXPLOSION))
            {
                ...
                {
					me->NearTeleportTo(1103.69f, 1048.76f, 512.279f, 0);
					me->GetMotionMaster()->MoveJump(1103.69f, 1048.76f, 512.279f, 50, 50);
                    ...
                    castArcaneExplosionTimer = 2000;
					arcaneExplosionTimer = 8500;
                }else castArcaneExplosionTimer -= uiDiff;
            }

            if (canGoBack)
            {
                if (arcaneExplosionTimer <= uiDiff && canCast)
                {
                    Position pPos;
        ...
        void SpellHit(Unit* /*pCaster*/, const SpellInfo* pSpell)
        {
            ...
            {		
                case SPELL_SUMMON_MENAGERIE:
					...
					//me->NearTeleportTo(968.66f, 1042.53f, 527.32f, 0.077f);
                    LeaveCombat();
                    me->CastSpell(me, SPELL_EVOCATE);
                    break;
                case SPELL_SUMMON_MENAGERIE_2:
                    me->SetHomePosition(1164.02f, 1170.85f, 527.321f, 3.66f);
					//me->NearTeleportTo(1164.02f, 1170.85f, 527.321f, 3.66f);
                    LeaveCombat();
                    me->CastSpell(me, SPELL_EVOCATE);
                    break;
                case SPELL_SUMMON_MENAGERIE_3:
                    me->SetHomePosition(1118.31f, 1080.377f, 508.361f, 4.25f);
					//me->NearTeleportTo(1118.31f, 1080.377f, 508.361f, 4.25f);
                    LeaveCombat();
                    me->CastSpell(me, SPELL_EVOCATE);
                    break;
                case SPELL_TELEPORT:
