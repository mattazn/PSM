...
enum Spells
{
    ...
    SPELL_VANISH                                  = 55964, // Bugged, don't use.
	SPELL_VANISH_VISUAL							  = 29448,//24222,
...
public:
    ...
    struct boss_taldaramAI : public ScriptedAI
    {
                    ...
                    case NORMAL:
                        ...
                        if (uiFlamesphereTimer <= diff)
                        {
							...
							if (Unit* target = SelectTarget(SELECT_TARGET_RANDOM, 0, 100, true))
								me->CastSpell(target, SPELL_CONJURE_FLAME_SPHERE, false);
        ...
        void RemovePrison()
        {
            ...
            me->SetHomePosition(me->GetPositionX(), me->GetPositionY(), DATA_GROUND_POSITION_Z, me->GetOrientation());
            me->SetPosition(me->GetPositionX(), me->GetPositionY(), DATA_GROUND_POSITION_Z, me->GetOrientation());
            Talk(SAY_WARNING);
