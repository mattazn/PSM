...
enum Spells
{
    SPELL_SPHERE_VISUAL                           = 56102, //56075,
...
public:
    ...
    struct boss_jedoga_shadowseekerAI : public ScriptedAI
    {
        ...
        void Reset()
        {
			me->NearTeleportTo(372.330994f, -705.278015f, -0.624178f,  5.427970f);
...
// ------------------------------------------------------------------------------------------------------------
// Jedogas Controller - Entry: 30181
// ------------------------------------------------------------------------------------------------------------
enum AufseherSpell
{
