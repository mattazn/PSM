...
void AchievementMgr::CompletedAchievement(AchievementEntry const* achievement)
{
	...
	// Don't let people with disabled achievements get realm first levels
	if ((achievement->flags & ACHIEVEMENT_FLAG_REALM_FIRST_REACH) && !(achievement->flags & ACHIEVEMENT_FLAG_REALM_FIRST_KILL) && GetPlayer()->IsRFsDisabled())
		return;
