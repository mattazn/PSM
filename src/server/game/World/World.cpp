...
void World::LoadConfigSettings(bool reload)
{
    ...
    m_int_configs[CONFIG_MOVEMENT_CHECKS_ACCESSLEVEL] = ConfigMgr::GetIntDefault("MovementChecker.skipgmlvl", SEC_CONSOLE);
    m_bool_configs[CONFIG_MOVEMENT_CHECKS_SPEED] = ConfigMgr::GetBoolDefault("MovementChecker.speed", true);
    m_bool_configs[CONFIG_MOVEMENT_CHECKS_FLYING] = ConfigMgr::GetBoolDefault("MovementChecker.flying", true);
    m_bool_configs[CONFIG_MOVEMENT_CHECKS_PLANE] = ConfigMgr::GetBoolDefault("MovementChecker.plane", true);
    m_bool_configs[CONFIG_MOVEMENT_CHECKS_WATERWALK] = ConfigMgr::GetBoolDefault("MovementChecker.waterwalk", true);
    m_bool_configs[CONFIG_MOVEMENT_CHECKS_MULTIJUMP] = ConfigMgr::GetBoolDefault("MovementChecker.multijump", true);
