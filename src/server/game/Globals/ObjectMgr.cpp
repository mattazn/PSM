...
void ObjectMgr::LoadChatFilter()
{
 ...
 if (!result)
 {
sLog->outInfo(LOG_FILTER_SERVER_LOADING, ">> Loaded 0 ChatFilter words. DB table `chat_filter` is empty.");
 ...
 sLog->outInfo(LOG_FILTER_SERVER_LOADING, ">> Loaded %u chat filter words in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
