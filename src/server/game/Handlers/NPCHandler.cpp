...
void WorldSession::SendTrainerList(uint64 guid, const std::string& strTitle)
{
	...
	float fXPDiscountMod = _player->GetXpRate();
    ...
    for (TrainerSpellMap::const_iterator itr = trainer_spells->spellList.begin(); itr != trainer_spells->spellList.end(); ++itr)
    {
		...
		if(tSpell->spell == 33389 || tSpell->spell == 33392 || tSpell->spell == 34092 || tSpell->spell == 34093 || tSpell->spell == 54198 || tSpell->spell == 1710 || tSpell->spell == 5785 || tSpell->spell == 23215 || tSpell->spell == 34766 || tSpell->spell == 54197)
			fXPDiscountMod = 1;

		if(tSpell->spell == 54197 || tSpell->spell == 33391 || tSpell->spell == 33388 || tSpell->spell == 34090 || tSpell->spell == 34091 || tSpell->spell == 23161 || tSpell->spell == 23214 || tSpell->spell == 40120)
			fXPDiscountMod = 1;
        ...
        data << uint32(floor((tSpell->spellCost * fDiscountMod)) / fXPDiscountMod);
...
void WorldSession::HandleTrainerBuySpellOpcode(WorldPacket & recvData)
{
    ...
    if (!trainer_spell)
		...
		if(trainer_spell->spell == 33389 || trainer_spell->spell == 33392 || trainer_spell->spell == 34092 || trainer_spell->spell == 34093 || trainer_spell->spell == 54198 || trainer_spell->spell == 1710 || trainer_spell->spell == 5785 || trainer_spell->spell == 23215 || trainer_spell->spell ==34766)
			fXPDiscountMod = 1;

		if(trainer_spell->spell == 54197 || trainer_spell->spell == 33391 || trainer_spell->spell == 33388 || trainer_spell->spell == 34090 || trainer_spell->spell == 34091 || trainer_spell->spell == 23161 || trainer_spell->spell == 23214 || trainer_spell->spell == 40120)
			fXPDiscountMod = 1;
    ...
    uint32 nSpellCost = uint32(floor((trainer_spell->spellCost * _player->GetReputationPriceDiscount(unit)) / fXPDiscountMod));
