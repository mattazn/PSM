...
class Unit : public WorldObject
{
    public:
		...
		Unit* SelectNearbyFriendly(Unit* exclude = NULL, float dist = NOMINAL_MELEE_RANGE) const;
		Unit* SelectNearbyFriendlyMissingBuff(Unit* exclude = NULL, float dist = NOMINAL_MELEE_RANGE, uint32 spell = 0) const;
		Unit* SelectNearbyFriendlyCCed(Unit* exclude = NULL, float dist = NOMINAL_MELEE_RANGE) const;
		Unit* SelectNearbyFriendlyMissingMostHP(Unit* exclude = NULL, float dist = NOMINAL_MELEE_RANGE, uint32 hp = 0) const;
