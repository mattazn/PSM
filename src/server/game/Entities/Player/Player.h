...
class Player : public Unit, public GridObject<Player>
{
    ...
    public:
        ...
        void SetXpRate(uint8 xp_rate) { m_xp_rate = xp_rate; }
		uint8 getGroupXP() const { return groupXP; }
		void setGoupXP(uint8 m_groupXP) { groupXP = m_groupXP; }

        float GetRestBonus() const { return m_rest_bonus; }
        void SetRestBonus(float rest_bonus_new);

		bool IsRFsDisabled() const { return achiDisabled; }
		void SetRFsDisabled(bool disabled) { achiDisabled = disabled; }
