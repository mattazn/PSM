    ...
    switch (spellproto->SpellFamilyName)
    {
        case SPELLFAMILY_GENERIC:
        {
            ...
            // ToC Icehowl Arctic Breath
                ...
                return DIMINISHING_NONE;
			// Earthgrab
			else if(spellproto->SpellIconID == 40)
...
void SpellMgr::LoadSpellCustomAttr()
{
    ...
    for (uint32 i = 0; i < GetSpellInfoStoreSize(); ++i)
    {
        ...
        switch (spellInfo->Id)
        {
			...
			case 28734: // Azjol'Nerub Skirmisher Backstab
...
void SpellMgr::LoadDbcDataCorrections()
{
    ...
    for (uint32 i = 0; i < sSpellStore.GetNumRows(); ++i)
    {
        ...
        switch (spellInfo->Id)
        {
			// Begin Pre-Nerf Spell Value adjustments
			case 28547: // Chill - Sapph
				spellInfo->EffectBasePoints[0] += 2500;
				break;
			case 53850: // Shadow burst
			case 53851: // Shadow burst
			case 56065: // Shadow bolt volley
			case 56064: // Shadow bolt volley
				spellInfo->EffectBasePoints[0] += 1000;
				break;
			case 28783: // Impale - Anub'rekhan
				spellInfo->AttributesEx3 |= SPELL_ATTR3_IGNORE_HIT_RESULT;
				spellInfo->EffectBasePoints[0] += 2000;
				break;
			case 51422: // Turret spell
            ...
            case 6774: // Slice and Dice rank 2
                ...
                break;
			case 33661: // Skeletal Smith - Naxxramas - Crush Armor
			...
			case 69512:
			case 60107:
				//spellInfo->EffectBasePoints[1] = 60;
				//spellInfo->AttributesEx4 -= SPELL_ATTR4_CAST_ONLY_IN_OUTLAND;
				break;
			// Wintergrasp Victory/Defeat should be castable while dead
			case 56902:
				spellInfo->EffectBasePoints[1] = 0;
				spellInfo->EffectItemType[1] = 0;
			case 58494:
				spellInfo->AttributesEx2 |= SPELL_ATTR2_CAN_TARGET_DEAD;
				break;
			// Wrath of the Plaguebringer - Noth 10/25
			case 29214:
			case 54836:
            ...
            // this is the only known exception, probably just wrong data
			 ...
			 // Craft Moonshroud
			 case 56001:
				 spellInfo->RecoveryTime = (3*24 + 20) * 60 * 60 * 1000; // 3d 20h cooldown
				 spellInfo->AreaGroupId = 823; // Emerald Dragonshrine
				 break;
			 // Craft Ebonweave
			 case 56002:
				 spellInfo->RecoveryTime = (3*24 + 20) * 60 * 60 * 1000; // 3d 20h cooldown
				 spellInfo->AreaGroupId = 1184; // Maw of Neltharion
				 break;
			 // Craft Spellweave
			 case 56003:
				 spellInfo->RecoveryTime = (3*24 + 20) * 60 * 60 * 1000; // 3d 20h cooldown
				 spellInfo->AreaGroupId = 1183; // Azure Dragonshrine
				 break;
			 // Smelt Titansteel
			 case 55208:
				 spellInfo->RecoveryTime = (20) * 60 * 60 * 1000;
				 break;
			 // Transmute: Titanium
			 case 60350:
				 spellInfo->RecoveryTime = (3*24 + 20) * 60 * 60 * 1000; // 3d 20h cooldown
			...
			case 55269: // Deathly Stare
				...
				break;
			case 50990: // Catapult Flame Breath
			case 50989: // Catapult Flame Breath
				spellInfo->EffectBasePoints[0] = 76;
				spellInfo->EffectBasePoints[1] = 76;
				break;
			case 58012: // Portal spell in Violet Hold
			...
			case 57697: //Lavastrike Hack - Sartharion
				...
				break; 
			case 57491: // Fire wall Sartharion
				spellInfo->EffectBasePoints[0] = 4000;
				spellInfo->EffectBasePoints[1] = 4000;
				break;
			case 58956: // Flame breath Heroic Sartharion
				spellInfo->EffectBasePoints[0] = 15000;
				break;
			case 48246: // Ball of Flame
				spellInfo->EffectBasePoints[0] += 2500;
                spellInfo->MaxAffectedTargets = 1;
				break;
			case 59192: // 25 man Hateful Strike - Patchwerk
				spellInfo->EffectBasePoints[0] += 7000;
				break;
			case 32309: // Slime Bolt - Patchwerk
				spellInfo->EffectBasePoints[0] += 9000;
				break;
			case 28836: // Mark Damage - Four Horsemen
				spellInfo->AttributesEx4 |= SPELL_ATTR4_IGNORE_RESISTANCES;
				break;
			case 57464: // Shadowbolt - Four Horsemen - 25 Man
				spellInfo->EffectBasePoints[0] += 750;
				break;
			case 57466: // Holy Wrath - Foure Horsemen - 25 Man
				spellInfo->EffectBasePoints[0] += 500;
				break;
			case 57465: // Holy Bolt - Four Horsemen - 25 Man
				spellInfo->EffectBasePoints[0] += 1000;
				break;
			case 39004:
			case 49699: // Consumption
				spellInfo->EffectBasePoints[0] += 4000;
				break;
			//case 29306: // Infected Wound - Gluth
			//case 59116: // Poison Cloud - Grobbulus
				//spellInfo->AttributesEx3 -= SPELL_ATTR3_STACK_FOR_DIFF_CASTERS;
				//break;
			// End Pre-nerf Spell Value adjustments
            case 50833:
			...
			case 57748: // Sear Beam
			case 58938: // Sear Beam
            ...
            case 51470: // Elemental Oath (Rank 2)
                ...
                break;
			case 47944: // Omoroks Crystal Spike - The Nexus
			case 48400: // Frost Tomb 1 - Utgarde Keep
			case 42672: // Frost Tomb 2
			case 42714: // Frost Tomb 3
				spellInfo->AttributesEx3 |= SPELL_ATTR3_IGNORE_HIT_RESULT;
				break;
			case 57912: // Arcane Lightning - Violet Hold
				spellInfo->TargetCreatureType = TYPEID_UNIT|TYPEID_CORPSE;
				break;
            /*case 55098: // Transform - Gundrak
