...
http://svn.code.sf.net/p/likef/code-0/trunk/Sources/game/spell/SpellAuras.cpp
Mangos has a similar function.
    ...
    if (apply)
    {
        switch (GetSpellInfo()->SpellFamilyName)
        {
            case SPELLFAMILY_GENERIC:
					// Corpse Explode (Normal & Heroic)
					if (GetSpellInfo()->SpellIconID == 263)
					{
						uint32 spell_id = 0;
						switch(GetId())
						{
						   case 49555: spell_id = 49618; break; // Normal
						   case 59807: spell_id = 59809; break; // Heroic
						}
