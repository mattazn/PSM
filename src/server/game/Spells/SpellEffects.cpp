...
void Spell::EffectDummy(SpellEffIndex effIndex)
{
    ...
    switch (m_spellInfo->Id)
    {
                case 26373:
                {
                     ...
                     m_caster->ToPlayer()->TeleportTo(1,7581.01f,-2225.35f,473.64f,1.80f);
                     return;
                }
    }
...
void Spell::EffectSanctuary(SpellEffIndex /*effIndex*/)
{
        ...
        && (m_spellInfo->SpellFamilyFlags[0] & SPELLFAMILYFLAG_ROGUE_VANISH))
    {
		...
		m_caster->ToPlayer()->RemoveAurasDueToSpell(53407); // Judgement of Justice
        // Overkill
...
void Spell::EffectLeap(SpellEffIndex effIndex)
{
    ...
    Position pos;
	float destx, desty, destz, x, y, z, ground, colz, floor;
	uint32 mapid;
	...
	destx = destTarget->GetPositionX();
	desty = destTarget->GetPositionY();
	destz = destTarget->GetPositionZ();
	mapid = destTarget->GetMapId();
    ...
    if (col)
    {
        ...
        ground = unitTarget->GetMap()->GetHeight(destx, desty, z, true, 50);
        floor = unitTarget->GetMap()->GetHeight(destx, desty, z, true, 50);
    ...
    unitTarget->NearTeleportTo(destx, desty, destz, pos.GetOrientation(), unitTarget == m_caster);
